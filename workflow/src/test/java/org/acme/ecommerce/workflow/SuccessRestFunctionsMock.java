...
public class SuccessRestFunctionsMock implements QuarkusTestResourceLifecycleManager {
    ...
    public void inject(Object testInstance) {
        if (testInstance instanceof EcommerceSuccessFlowTest) {
            ((EcommerceSuccessFlowTest) testInstance).successMockServer = wireMockServer;
        }
    }
}
